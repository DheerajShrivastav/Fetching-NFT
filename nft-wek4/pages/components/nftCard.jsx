  ...
  return (
    <div className="w-1/4 flex flex-col">
      <div className="rounded-md">
        <img className="object-cover h-128 w-full rounded-t-md" src={nft.media[0].gateway} alt="NFT"></img>
      </div>
      ...
      <div className="flex justify-center nb-1">
        <a href={`http://etherscan.io/token/${nft.contract.address}`} target="_blank" rel="noopener noreferrer" className="py-2 px-4 bg-blue-500 w-1/2 text-center rounded-m text-white">View on etherscan</a>
      </div>
    </div>
  );
};
