...
import { useState } from "react";
import { NFTCard } from "./components/nftCard";
>>>>>>> e7f68e0ada872215304b401bfef42c5c0b61cc46
...
=======
    const api_key = "jN5oT-WBScZGMluUd8bVEzYzMEBNkYfY";
    const baseURL = `https://eth-mainnet.alchemyapi.io/v2/${api_key}/getNFTs/`;
  ...
  return (
    <div className="flex flex-col items-center justify-center py-8 gap-y-3">
      <div className="flex flex-col w-full justify-center items-center gap-y-2">
        <div className=" underline decoration-sky-500 mt-6">
          Entre Your wallet address here
        </div>
        <input
        ...
        />
        <div className=" underline decoration-sky-500 mt-6">
          Add the collection address here
        </div>
        <input
          className="w-2/5 bg-slate-100 py-2 px-2 rounded-lg text-gray-800 focus:outline-blue-300 disabled:bg-slate-50 disabled:text-gray-50 mt-2"
          onChange={(e) => {
